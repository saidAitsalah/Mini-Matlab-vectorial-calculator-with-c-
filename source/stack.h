...
/* commands */
typedef enum {
	c_none=-1, c_allv, c_quit, c_hold, 
	c_shg, c_load, c_udf, c_return, c_endfunction, c_for, c_end, 
	c_break, c_loop, c_to, c_do, c_step, c_if, c_repeat, c_then, c_endif, c_else, 
	c_elseif, c_clear, c_clg, c_cls, c_exec, c_forget, c_global
} comtyp;
